...
class AppStateNotifier extends ChangeNotifier {
  SafeDatesFirebaseUser? initialUser;
  SafeDatesFirebaseUser? user;
  ...
  void update(SafeDatesFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'findInterests',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'findInterests')
                  : FindInterestsWidget(),
            ),
            FFRoute(

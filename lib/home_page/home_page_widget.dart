                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'imgms6dg' /* Your next appointment */,
                            ),
                              ...
                              child: StreamBuilder<AppointmentsRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_PAGE_appointmentCard_ON_TAP');
                                      logFirebaseEvent(
                              ...
                              Material(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_PAGE_Row_efwrpj2t_ON_TAP');
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: AutoSizeText(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'c9r6e02i' /* Schedule a day with your poten... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    logFirebaseEvent(
                                        'homeCard_Appointments_launch_u_r_l');
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'tsd5wbce' /* Make a direct call in order to... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ga8tujoy' /* Send them a message directly a... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)

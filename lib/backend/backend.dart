...
import 'schema/user_interests_record.dart';
...
export 'schema/user_interests_record.dart';
...
/// Functions to query UserInterestsRecords (as a Stream and as a Future).
Stream<List<UserInterestsRecord>> queryUserInterestsRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      UserInterestsRecord.collection(parent),
...
Future<List<UserInterestsRecord>> queryUserInterestsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<UserInterestsRecord>> queryUserInterestsRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,

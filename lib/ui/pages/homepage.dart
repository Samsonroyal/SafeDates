...
class WhatDoYouNeedItem extends StatelessWidget {
  ...
  const WhatDoYouNeedItem({Key? key, required this.asset, required this.text}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      height: 200,
...
class WalletItem extends StatelessWidget {
  final String icon;
  final String name;
  const WalletItem({Key? key, required this.icon, required this.name}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Expanded(
      child: Container(
